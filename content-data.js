const CONTENT = {
  ...
  "copyright": "© 2026 Cenoir Studios. All rights reserved.",
  "socials": [
    {
      "label": "X",
      "url": "https://x.com/CenoirStudios",
      "icon": "x"
    },
    {
      "label": "LinkedIn",
      "url": "https://linkedin.com/company/cenoir-studios",
      "icon": "linkedin"
    },
    {
      "label": "YouTube",
      "url": "https://www.youtube.com/channel/UCj93N51pGqO9jpdDMLw75QQ",
      "icon": "youtube"
    },
    {
      "label": "Instagram",
      "url": "https://www.instagram.com/cenoir.studios/",
      "icon": "instagram"
    },
    {
      "label": "TikTok",
  ...
  "emails": {
    "contact": "contact@cenoirstudios.com",
    "careers": "careers@cenoirstudios.com",
  ...
  "pillars": [
    {
      ...
      "text": "Every mechanic, every environment, every encounter serves the story we want to tell."
    },
    {
      "icon": "🎨",
      "title": "Art-Driven",
      "text": "Stylized visuals that create mood and atmosphere beyond what realism alone can achieve."
    },
    {
      "icon": "⚡",
  ...
  "hero": {
    ...
    "description": "Development logs, announcements, and behind-the-scenes notes from the Cenoir team."
  },
  "entries": [
    {
      "day": "24",
      "month": "May 2026",
      "title": "Website Redesign Live",
      "text": "The Cenoir Studios website has been rebuilt with separate sections for projects, news, and careers. The projects page now features a concept art gallery showcasing environment art from NoSaints: New Dawn.",
      "tag": "Studio"
    },
    {
      "day": "15",
      "month": "May 2026",
      "title": "NoSaints: Combat System Progress",
      "text": "The combat feature module is taking shape — states for melee, ranged, and ability-based actions are now running through the priority-based state machine. KINEMATION procedural animation is driving weapon sway and recoil.",
      "tag": "Development"
    },
    {
      "day": "02",
      "month": "Apr 2026",
      "title": "Movement System Overhaul",
      "text": "The character movement feature has been refactored into a clean MVP + State Machine architecture. Idle, Move, Sprint, Jump, Crouch, and Slide states are now ScriptableObject-based and fully priority-driven.",
      "tag": "Development"
    },
    {
      "day": "10",
      "month": "Feb 2026",
      "title": "Environment Concept Art Reveal",
      "text": "Seven new concept art pieces for NoSaints: New Dawn are now public — featuring the game's signature amber-lit cityscapes, industrial architecture, and the interior of the Blue Whale bar. Art by Andrey Ivasenko.",
      "tag": "Art"
    },
    {
      "day": "01",
      "month": "Jan 2026",
      "title": "Cenoir Studios Founded",
      "text": "The official founding of Cenoir Studios. A small team, a big vision, and the beginning of NoSaints — our debut project.",
      "tag": "Studio"
    }
  ]
},
  ...
  "roles": [
    {
      ...
      "location": "🌍 Remote",
      "type": "🔴 Critical",
      "about": "NoSaints needs a voice — weapon SFX, atmospheric ambience, UI audio feedback, and spatial sound for our noir 1930s world. This is a critical gap that directly blocks development progress.",
      "tasks": [
        "Design weapon firing and reload sound effects",
        "Create ambient soundscapes (1930s city streets, interiors, rain)",
        "Design UI audio feedback (menu clicks, notifications, HUD cues)",
        "Implement spatial audio for multiplayer environments",
        "Create impact and destruction sound effects"
      ],
      "tools": [
        "FMOD or Wwise for integration",
        "Audacity, Reaper, or equivalent DAW",
    ...
    },
    {
      ...
      "location": "🌍 Remote",
      "type": "🟠 High Priority",
      "about": "Lead the quality assurance process for NoSaints. You'll design test plans, triage bugs, coordinate playtest sessions, and determine build stability for release milestones.",
      "tasks": [
        "Design test plans for each development milestone",
        "Triage and prioritize bug reports",
        "Coordinate playtest sessions with the team",
        "Verify bug fixes and run regression testing",
        "Assess build stability and release readiness",
    ...
    },
    {
      ...
      "tasks": [
        ...
        "Create adaptive in-game music (combat, exploration, tension)",
        "Design faction-specific musical motifs",
        "Mix and master all music tracks"
      ],
      "tools": [
